...
MSG_PROFILE_SAVED = """Твой профиль принят, {}!
Не забывай обновлять профиль у меня."""
MSG_PROFILE_CASTLE_MISTAKE = """\
Перед тобой лежит огромный черепаший панцирь.
Жаль, что входа ты так и не нашел.
Долгие часы скитаний не привели тебя ни к чему. Без проводника здесь делать нечего..."""
...
# main.py texts
MSG_MAIN_INLINE_BATTLE = 'ЗА ТОРТУГУ!'
...
MSG_SQUAD_THORNS_ENABLED = 'Густой туман скрыл ваше поселение от посторонних.'
MSG_SQUAD_THORNS_DISABLED = 'Туман развеялся, \
теперь каждый может посетить нас'
...
MSG_THORNS = '{} заблудился в густом тумане, вряд ли мы его еще увидим.'
...
MSG_NO_USERNAME = 'Нам с тобой будет сложно общаться, пока ты не сделаешь себе юзернейм. ' \
